...
{
	int i1,j1;
	for(i1=i+1,j1=j+1;i1<10&&j1<10&&(C[i1][j1]==' '||C[i1][j1] =='*');i1++,j1++)
		set(i1,j1);
	for(i1=i-1,j1=j-1;i1>1&&j1>1&&(C[i1][j1]==' '||C[i1][j1]=='*');i1--,j1--)
		set(i1,j1);
	for(i1=i-1,j1=j+1;i1>1&&j1<10&&(C[i1][j1]==' '||C[i1][j1]=='*');i1--,j1++)
		set(i1,j1);
	for(i1=i+1,j1=j-1;i1<10&&j1>1&&(C[i1][j1]==' '||C[i1][j1]=='*');i1++,j1--)
		set(i1,j1);
}
